...
def testpreprocess():
    # Example usage
    trainset_dir = "/home/meowpong/Desktop/rvc/mydataset/andrew_huberman"
    exp_dir = "testing40k"
    sr = "40k"  # Sampling rate
...
def test_Feature_extraction():
    ...
    for log in extract_f0_feature("",1,"rmvpe",True,"testing40k","V2",""):
        print(log)
...
def test_index_traing():
    for log in train_index("testing40k","V2"):
        print(log)
